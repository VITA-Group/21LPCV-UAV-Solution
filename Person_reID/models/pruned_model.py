...
import sys
from .pruned_resnet import resnet18
...
class ft_net_8(nn.Module):
    ...
    def __init__(self, class_num, droprate=0.5, stride=2, circle=False):
        ...
        self.model = model_ft
        self.circle = circle
        self.classifier = ClassBlock(64, class_num, droprate, return_f = circle)

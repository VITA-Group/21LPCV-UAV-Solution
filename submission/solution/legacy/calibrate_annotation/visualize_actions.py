...
from utils.experimental import load_labels_json
...
if __name__ == '__main__':
    ...
    labels_path = os.path.join(dir_path, 'data/inputs', args.video_name, 'labels')
    gt_action_labels_path = os.path.join(dir_path, 'data/inputs', args.video_name, '{}_action.csv'.format(args.video_name))
    noisy_action_labels_path = os.path.join(dir_path, 'data/inputs', args.video_name, '{}_action_noisy.csv'.format(args.video_name))

    corrected_video_path = os.path.join(dir_path, 'data/outputs', args.video_name, 'calibration')
    ...
    for path, img_orig, vid_cap in dataset:
        ...
        DrawTool.draw_frame_idx(img_gt, frame_idx, 'GroundTruth')
        DrawTool.draw_frame_idx(img_noisy, frame_idx, 'Noisy')
        repeat = 1

...
class CropsBoxesCache(object):
    def __init__(self, pred_frames, gt_frames, persons_count, balls_count, person_crop_height, person_crop_width, ball_crop_height, ball_crop_width):
        self.pred_frames = pred_frames
        self.gt_frames = gt_frames

        self.gt_persons_crop_cache = np.zeros((len(gt_frames), persons_count, person_crop_height, person_crop_width, 3), dtype=np.uint8)
        self.gt_balls_crop_cache = np.zeros((len(gt_frames), balls_count, ball_crop_height, ball_crop_width, 3), dtype=np.uint8)
        ...
        self.pred_persons_crop_cache = np.zeros((len(pred_frames), persons_count, person_crop_height, person_crop_width, 3), dtype=np.uint8)
        self.pred_balls_crop_cache = np.zeros((len(pred_frames), balls_count, ball_crop_height, ball_crop_width, 3), dtype=np.uint8)

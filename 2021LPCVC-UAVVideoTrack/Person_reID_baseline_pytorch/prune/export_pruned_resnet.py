# Delete the pruned channels and export the pruned model
import sys
sys.path.insert(0, '..')
import os
import argparse
...
######################################################################
add_new = False
my_file_name = 'Erase_0.75_64.pth'
my_save_name = 'Erase_0.875_cut.pth'
# Load model
#---------------------------
...
model_structure = ft_net_4(class_num=3465, droprate=0.5, stride=2, circle =True)
model = load_network(model_structure, '../model/ResNet18_Pruned/' + my_file_name)
...
save_filename = 'Erase_0.875_new.pth'
...
###########################################################
model = model.eval()
model_new = ft_net_4(class_num=3465, droprate=0.5, stride=2, circle =True)

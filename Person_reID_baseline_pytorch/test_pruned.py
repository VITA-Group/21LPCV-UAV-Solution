...
import yaml
import math
from models.pruned_model import ft_net, ft_net_dense, ft_net_NAS, PCB, PCB_test
...
parser.add_argument('--name', default='ResNet18', type=str, help='save model path')
...
def load_network(network):
    save_path = './model/ResNet18_Pruned/pruned_FPGM_0.875_2.pth'
...
os.system('/home/wuzhenyu_sjtu/anaconda3/envs/pytorch_1.7.1/bin/python evaluate_gpu.py | tee -a %s'%result)
